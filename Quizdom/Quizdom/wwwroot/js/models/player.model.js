    ...
    (function (Models) {
        var PlayerModel = (function (_super) {
            ...
            function PlayerModel(user, gamePlayer) {
                ...
                _this.questionsRight = 0;
                _this.questionsRightDelay = 0;
                _this.questionsWon = 0;
                _this.gamesQuestionsRight = 0;
                _this.gamesQuestionsRightDelay = 0;
                _this.gamesQuestionsWon = 0;
                _this.gamesPlayed = 0;
                _this.gamesWon = 0;
                ...
                _this.questionsRight = gamePlayer.questionsRight;
                _this.questionsRightDelay = gamePlayer.questionsRightDelay;
                _this.questionsWon = gamePlayer.questionsWon;
                _this.gamesQuestionsRight = 0;
                _this.gamesQuestionsRightDelay = 0;
                _this.gamesQuestionsWon = 0;
                _this.gamesPlayed = 0;
